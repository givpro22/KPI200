...
public class INITIAL extends JFrame {
	...
	public INITIAL() {
		...
		// start 버튼 관련 코드
		startButton.setBounds(500, 500, 240, 45); // 게임시작 버튼의 위치와 크기 조정
		...
		startButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				startButton.setCursor(new Cursor(Cursor.HAND_CURSOR)); // 마우스 커서 바뀜
			}
			...
			public void mousePressed(MouseEvent e) {
				...
				title = new ImageIcon(Main.class.getResource("/images/news.png")).getImage();
